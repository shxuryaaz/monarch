            ...
            <div className="flex flex-col justify-center gap-6 p-6 sm:p-8 lg:p-10 lg:pl-8">
              ...
              <div className="rounded-xl border border-border/80 bg-secondary/25 px-5 py-4">
                ...
                <dl className="mt-4 grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <dd className="mt-0.5 font-semibold tabular-nums text-foreground">{formatUsd(asset.totalAssetValue)}</dd>
                  </div>
                </dl>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-xl border border-border bg-card p-5 shadow-sm">
                  ...
                  {investBounds?.valid ? (
                    <>
                      <p className="mt-2 text-2xl font-bold tabular-nums text-foreground">{formatUsd(investUsdClamped)}</p>
                      <div className="mt-3">
                  ...
                  >
                    {walletLine ?? `Invest ${formatUsd(investUsdClamped)}`}
                  </button>
                  {needsUsdc && !canAfford && token ? (
                    <p className="mt-3 text-center text-xs text-amber-200/90">
                      Fund at least {formatUsd(investUsdClamped)} USDC on Sepolia first.
                    </p>
                  ) : null}
                </div>
              </div>
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6 sm:p-7">
            ...
            <dl className="mt-5 space-y-4 text-sm">
              ...
              <div>
                ...
                <dd className="mt-1 text-lg font-semibold tabular-nums text-foreground">{formatUsd(trustFin.rentalIncomeAnnualUsd)}</dd>
                <dd className="mt-0.5 text-xs text-muted-foreground">
                  ~{formatUsd(trustFin.rentalIncomeMonthlyUsd)} / month (model allocation)
                </dd>
              </div>
              <div>
